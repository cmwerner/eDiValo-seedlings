...
Total biomass and shoot length--these are pretty strongly correlated (R^2 of almost 0.7), I think it will probably be best to not include shoot length in the analyses
