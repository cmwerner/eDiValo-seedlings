...
# just looking at fall and spring since these are
# 1. more abudnant 2. less likely to have repeats (require time series analyses)
...
ggsave(filename = 'species_time.pdf', width=6, height=5, units='in')
