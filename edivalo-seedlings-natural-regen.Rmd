...
# including climate
m.biomass1.0 <- glmmTMB(count.max ~ grazing * nutrient + climate + light +
                         (1|species) + (1|block:plotid),
                       nat.seedlings.traits, family = nbinom2)

m.biomass1.1 <- glmmTMB(count.max ~ grazing * nutrient + climate + light + bm.tot +
                         (1|block:plotid), 
                 nat.seedlings.traits, family = nbinom2)

m.biomass1.2 <- glmmTMB(count.max ~ grazing * nutrient + climate + light + bm.tot +
                         (1|species) + (1|block:plotid), 
                 nat.seedlings.traits, family = nbinom2)


m.biomass1.full <- glmmTMB(count.max ~ grazing * nutrient + climate + light + bm.tot +
                           grazing*nutrient*climate*light*bm.tot +
                         (1|species) + (1|block:plotid), 
                 nat.seedlings.traits, family = nbinom2)

m.biomass1.specific <- glmmTMB(count.max ~ grazing * nutrient + climate + light + bm.tot +
                           light*grazing*bm.tot + light*grazing*nutrient + climate*light*bm.tot +   climate*nutrient*bm.tot + climate*grazing*bm.tot +
                         (1|species) + (1|block:plotid), 
                 nat.seedlings.traits, family = nbinom2)
summary(m.biomass1.specific)

AICtab(m.biomass1.0, m.biomass1.1, m.biomass1.2, m.biomass1.full, m.biomass1.specific)

E2 <- resid(m.biomass1.specific, type = "pearson")
N  <- nrow(nat.seedlings.traits)
p  <- length(coef(m.biomass1.specific)) 
sum(E2^2) / (N - p)
```
...
# including climate
m.sla.1.0 <- glmmTMB(count.max ~ grazing * nutrient + light + climate +
                         (1|species) + (1|block:plotid),
                       nat.seedlings.traits, family = nbinom2)

m.sla.1.1 <- glmmTMB(count.max ~ grazing * nutrient + light + climate + sla.2 +
                         (1|block:plotid), 
                 nat.seedlings.traits, family = nbinom2)

m.sla.1.2 <- glmmTMB(count.max ~ grazing * nutrient + light + climate + sla.2 +
                         (1|species) + (1|block:plotid), 
                 nat.seedlings.traits, family = nbinom2)

m.sla.1.full <- glmmTMB(count.max ~ grazing * nutrient + light + climate + sla.2 +
                            grazing*nutrient*light*climate*sla.2 +
                        (1|species) + (1|block:plotid), 
                 nat.seedlings.traits, family = nbinom2)

m.sla.1.specific <- glmmTMB(count.max ~ grazing * nutrient + light + climate + sla.2 +
                           grazing*nutrient*light + grazing*light*sla.2 + nutrient*light*sla.2 + grazing*nutrient*climate*sla.2 +
                        (1|species) + (1|block:plotid), 
                 nat.seedlings.traits, family = nbinom2)
summary(m.sla.1.specific)

AICtab(m.sla.1.0, m.sla.1.1, m.sla.1.2, m.sla.1.full, m.sla.1.specific)

E2 <- resid(m.sla.1.specific, type = "pearson")
N  <- nrow(nat.seedlings.traits)
p  <- length(coef(m.sla.1.specific)) 
sum(E2^2) / (N - p) 
